...
export function RoleFitMiniFAQ({ locale }: { locale: RoleFitLocale }) {
  const t = roleFitAuditTranslations[locale].faq
  const icons = [Clock, FileCheck, Shield]
          ...
          {t.items.map((faq, i) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="font-bold text-slate-900 dark:text-white text-base mb-2">{faq.q}</h4>
