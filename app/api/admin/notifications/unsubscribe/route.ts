...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error('[API] admin/notifications/unsubscribe error:', error)
    return NextResponse.json({ success: false, error: 'Failed to unsubscribe admin notification token' }, { status: 500 })
  }
}
