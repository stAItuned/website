...
*   **Current Reality:** ~20 hours/client (Manual Tooling).
*   **Max Capacity:** One full-time expert can handle ~2 active cohorts (20 students) MAXIMUM if doing manual QA.
*   **Scaling Factor:** Automation of "Entity Extraction" (JD parsing) and "First Draft Generation" (Code/Docs) is required to unlock >200 students/year.

**Scenari SOM (capacity-driven):**

> Nota operativa: nel **Year 1** la cadence è in rampa (M5–M8: 1 coorte/mese; M9–M12: 2 coorti/mese).
...
**Definizioni:** qui “application qualificata” = Audit completo + fit minimo. Non confonderla con “lead” generico (DM/commento/iscrizione).

#### 💡 So What? (Implicazioni Strategiche)

1.  **Mercato sufficientemente grande + Urgenza:** il problema è monetizzabile *oggi*; la nicchia è stretta ma rigenerante (nuove coorti ogni mese).
...
- Career switcher early (se vuoi aumentare willingness-to-pay)
- Junior EU/EN (espansione)
- B2B HR/Academy (partnership)
...
### Channels (come li raggiungi)

- LinkedIn (contenuti + outbound mirato + proof)
- Blog stAItuned (SEO + authority)
- Community/università/associazioni (partnership leggere)
- Referral (da cohort e alumni)

### Customer relationships (come li servi)

- 1:1 productized (inizio)
- Coorte / cohort-lite (scaling)
- Community alumni + office hours (retention)
- Tool self-serve (riduce supporto umano)

### Revenue streams (come incassi)


**Nota su ricavi Tool (upside):** il **tool Career OS** (subscription) è pensato come **upsell/retention** e leva di scala (riduce ore umane e aumenta LTV).  
Nel **baseline Year 1** può essere trattato come **upside**: i conti devono tornare anche solo con 1:1 + coorti; il tool entra quando template/playbook e QA sono stabilizzati.

1. **Programmi**: Starter / Pro / Elite (pagamento una tantum o rate interne)
2. **Add-on**: extra JD pack, extra mock interview, extra review, extra articoli
3. **Tool**: abbonamento o crediti (editorial planner + career tools)
4. **Crediti extra tool** (pacchetti) come leva di aumento ARPU, soprattutto nel Pro.
5. (Futuro) **B2B productized** su processo ripetibile
****

### Key activities (cosa fai ogni settimana)
...
### Key partners (opzionali ma utili)

- Università/associazioni studentesche
- Community tech (eventi, meetup)
- Tool esterni (ATS check, calendly, payment, ecc.)
- (Futuro) aziende per “capstone” o use case

### Cost structure (principali costi)

- Tempo del team (il vero costo)
- Costi variabili per utente: tool usage (tu hai stimato ~5€ articolo + ~5€ CV pack)
- Hosting/infra
- Marketing (inizialmente basso, poi test)
- Eventuali collaboratori (dev/ops)
...
## 4) Pricing model (strategie possibili + pro/contro)

Qui non fissiamo numeri finali, ma definiamo **come** li fissi.

### Modello di pricing consigliato: “tier + sconti codificati”

- **Prezzo fisso per tier** (Starter/Pro/Elite)
- Sconti solo codificati: early bird / scholarship studenti (limitata) / referral
    
    **Perché:** evita negoziazione e preserva segnale qualità.
    

### Varianti di pricing (da scegliere a seconda del posizionamento)

1. **Premium-first** (meno clienti, ticket più alto): pro = principale
    - Pro: margini alti, meno burnout
    - Contro: junior price-sensitive → serve proof forte
2. **Mid-market** (volume medio, coorti piene): starter traina, pro upsell
    - Pro: più accessibile, riempi coorti
    - Contro: devi essere molto efficiente in delivery
3. **Accessibile + scholarship** (brand e community): entry più basso ma cap rigido
    - Pro: acquisisci e fai flywheel
    - Contro: rischio di attrarre clienti poco motivati → serve application

### Pagamenti (riduzione attrito)

- 1 pagamento unico (sconto “pay upfront”)
- 2–3 rate interne (non finanziarie)
    
    **Nota:** attenzione insoluti → regole chiare.
    

---

## 5) Unit economics (modello numerico: come sai se regge)

### Variabili chiave

- **T** = ore totali del team per cliente (target)
- **P** = prezzo del tier
- **Cv** = costo variabile tool per cliente (es. 10€–30€ a seconda di cosa include)
- **M** = margine lordo ≈ P − Cv (ignorando costi fissi)
- **€/h** = (P − Cv) / T → metrica regina per work-life balance

### Assunzioni iniziali (da validare)

- Per 1:1 avevi stimato ~10h per persona.
    
    Per scalare bene, il target sano è:
    
- **Starter 1:1:** ~8h
- **Pro 1:1:** ~20h (ATTENZIONE: alto, vedi financial_plan.md)
- **Elite 1:1:** ~20h + 1h/mese supporto
- **Coorte (per seat):** ~2-4h (leva 1:10)

### Perché questa parte è cruciale

Se il **€/h effettivo** è basso, sei un “servizio”; se sale grazie a coorti + tool + standard, diventi un business scalabile.

---

## 6) Delivery model (come consegni senza perdere qualità)
...
394: Questo è ciò che rende la qualità replicabile quando passi alle coorti.

## 6b) The "Wizard of Oz" Constraint (Phase 0 Reality)
Currently, the "AI Tool" (Career OS) is **simulated manually** by the Mentor.
*   **Pros:** High quality, perfect customization, learning the "corner cases".
*   **Cons:** **Zero Scalability**. 
*   **Mitigation:** 
    1.  **Cap Clients:** Max 5-8 active 1:1 clients (or 1 small cohort) per mentor.
    2.  **SOP-First:** Every manual action must update the "Algorithm Logic" (SOP) to be automated later. Do not ad-lib.
    3.  **Price Premium:** Charge for the "Human Intelligence", not the software.
396: ---

## 7) Go-to-market model (come acquisisci clienti, in modo ripetibile)
...
- LinkedIn è il canale primario iniziale (perché puoi mostrare proof e autorità)
- Il blog è “asset di compounding” (non immediato ma moltiplicatore nel tempo)
- I contenuti pubblicati su stAItuned diventano marketing organico continuo

---

## 8) Metriche (dashboard business model)

Non sono numeri “a caso”: sono le metriche che decidono se il modello è sano.
...
- % che acquistano add-on (JD extra, mock extra, articolo extra)
- % che passa a tool subscription
- referral rate (alumni → nuovi)

### Economics

- margine lordo per tier
- €/h effettivo
- capacità: # utenti in parallelo senza degradare quality

---

## 9) Rischi e mitigazioni (business model)

1. **Agency trap** (troppo custom)
    - mitigazione: tier standard + esclusioni + max revisioni
2. **Junior price sensitivity**
    - mitigazione: scholarship limitata + rate + proof molto forte
3. **Qualità contenuti pubblicati** (rischio reputazionale)
    - mitigazione: QA + rubriche + publish solo se supera standard
4. **Burnout**
    - mitigazione: cap ore/cliente + coorti + tool per ridurre supporto umano
5. **Claim “trovi lavoro”** (rischio aspettative)
    - mitigazione: prometti deliverable e processo, non “lavoro garantito”

---

## 10) Evoluzione del business model (1:1 → coorti → prodotto)

Questo è il ponte tra “oggi” e “scala”.

### Step A — 1:1 (validazione)

- vendi Starter/Pro
- costruisci case study
- costruisci SOP + template
- misuri €/h e outcome rate

### Step B — Cohort-lite (scala controllata)

- workshop settimanale di gruppo
- review limitate 1:1
- stesso outcome, meno ore per persona

### Step C — Coorte piena + tool recurring

- coorte come “core”
- 1:1 come premium add-on
- tool subscription + crediti come retention e upsell

---

# Estensione (opzionale) — Come entra il B2B nel business model (senza distrarti)

Se vuoi includerlo nel BM “a tendere”, scrivilo così:

**B2B non è una seconda azienda**: è un laboratorio a cap rigido che serve a productizzare una soluzione standard.

Ricavi B2B iniziali = pilot “productized” (setup + canone) solo su 1 processo ripetibile.

Gate: 3 clienti con stesso problema (80% uguale) → allora diventa “prodotto B2B”.