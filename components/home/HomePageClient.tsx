...
export function HomePageClient({ tickerArticles, contributorCount, articleCount }: HomePageClientProps) {
    ...
    return (
        <>
            ...
            {/* 2. Who We Are - The 3 Pillars */}
            <WhoWeAreSection />

            {/* 3. Differentiators - Why stAItuned */}
            <DifferentiatorsSection />

            {/* 4. Authority Feed (Articles with Toggle) */}
            <section className="py-20 px-4 md:px-6 max-w-full bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800" id="articles">
