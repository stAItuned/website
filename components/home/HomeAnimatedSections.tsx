...
interface HomeAnimatedSectionsProps {
  shortlistColumns?: unknown[] // kept for backwards compatibility
  posts?: unknown[]
...
/**
 * HomeAnimatedSections - Only ticker at bottom
 * DualTracks, Shortlist, NextStep removed (now on /aziende and /learn)
 */
