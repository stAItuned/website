  ...
  return (
    <section className="max-w-7xl mx-auto mt-8 px-4 sm:mt-12">
      <div className="text-center space-y-3">
        <p className="text-xs uppercase tracking-[0.3em] text-slate-500">stAItuned in numeri</p>
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <article
            key={stat.label}
            className="space-y-3 rounded-3xl border border-slate-100 bg-white/80 p-6 text-center shadow-sm transition hover:border-slate-200 hover:shadow-lg"
          >
