...
export function BadgeShareControls({ credentialId, title }: { credentialId: string, title: string }) {
    ...
    return (
        <div className="flex justify-center gap-3">
            ...
            <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-[#0077b5] hover:bg-[#006396] text-white rounded-lg text-sm font-medium transition-colors"
            >
