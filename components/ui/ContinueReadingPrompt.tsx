...
export function ContinueReadingPrompt({
    ...
    return (
        <div
            className={`fixed bottom-2 sm:bottom-6 left-0 right-0 z-[60] flex justify-center pointer-events-none transition-all duration-300 ${isLeaving ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'
                }`}
        >
            <div className="w-full max-w-2xl px-4 pointer-events-auto">
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-slate-700 p-4 backdrop-blur-xl relative overflow-hidden">
