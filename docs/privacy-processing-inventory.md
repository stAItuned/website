...
|---|---|---|---|---|---|---|---|
| Article views first-party | `POST /api/analytics/page-view` | article slug, timestamp, contatore aggregato | metriche editoriali aggregate senza GA | legittimo interesse; vedi purpose split in `docs/privacy-lawful-basis-matrix.md` | Firebase/Firestore | contatore cumulativo (no profilo utente) | privacy page (blog visits section) |
