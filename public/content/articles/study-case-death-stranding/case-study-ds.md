...
| ![Death Stranding key art featuring Sam Porter Bridges](./ds.jpg) |
|:--:|
...
| ![Sam Porter Bridges traversing a rocky landscape in Death Stranding](./ds2.jpg) |
|:--:|
...
| ![Navigation mesh visualization showing walkable areas in Death Stranding](./mesh.png) |
|:--:|
...
| ![Sam struggling to cross a fast-moving river in Death Stranding](./ds3.png) |
|:--:|
...
| ![Wide shot of the massive open world environment in Death Stranding](./ds4.jpg) |
|:--:|
...
| ![Detailed terrain rendering showing rocky ground texture in Decima Engine](./ds5.jpg) |
|:--:|
...
| ![A* Search Algorithm visualization finding a path between two points](./star.png) |
|:--:|
...
| ![NavMesh Bubble concept illustrating local navigation mesh generation around the player](./bubble.png) |
|:--:|
| <b>Image Credits: Death Stranding - AI Postmortem (GDC)</b>|
...
| ![Complex vertical navigation mesh for climbing mechanics](./mesh2.png) |
|:--:|
| <b>Image Credits: Death Stranding - AI Postmortem (GDC)</b>|
...
| ![Abstract pathfinding layer showing high-level navigation routes](./ds6.png) |
|:--:|
