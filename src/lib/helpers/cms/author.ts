...
const validAuthor: Record<keyof Omit<Author, 'propic' | 'articles' | 'slug' | 'html'>, string> = {
	name: 'string',
	team: 'string[]',
	title: 'string',
	linkedin: 'string',
...
const isValidAuthor = (input: any): input is Omit<Author, 'propic' | 'articles' | 'slug' | 'html'> => {
